...
namespace TaskA.Controllers
{
    public class TaskersController : Controller
    {
        ...
        {      
            ...
            {
                ViewBag.Taskers = context.Orders.SqlQuery(" SELECT * FROM dbo.Orders").Count();
            }
                return View(tasker);
        }
        ...
        public ActionResult SendEmail(string receiver, string subject, string message)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    var senderEmail = new MailAddress("bonkegama@outlook.com", "Task A Team");
                    var receiverEmail = new MailAddress(receiver, "Receiver");
                    var password = "Password@g.com";
                    var sub = subject;
                    var body = message;
