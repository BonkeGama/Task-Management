...
namespace TaskA.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var uidi = User.Identity.GetUserId();
            if (uidi == null)
            {
        ...
        public ActionResult OnceOff(int id)
        {
            ...
            // Buyer Details
            onceOffRequest.email_address = "bHonestp33@gmail.com";
            ...
            onceOffRequest.confirmation_address = "Honestp33@gmail.com";
            ...
            ViewBag.Body = $"Dear " + getclientName + " " + getlastName + "<br/>" +
              $"You have successfully paid for booking. Please wait for admin to approve and schedule your booking."+
              $"<br/>" +
              $"Task A";
        ...
        public ActionResult AdHoc()
        {
            ...
            // Buyer Details
            adHocRequest.email_address = "Honestp33@gmail.com";
