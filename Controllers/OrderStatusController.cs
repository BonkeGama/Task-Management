...
namespace TaskA.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderStatus_ID,Status_Name")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderStatus_ID,Status_Name")] OrderStatus orderStatus)
        {
            if (ModelState.IsValid)
            {
